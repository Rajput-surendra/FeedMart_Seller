final String appName = ' FEED MART Seller';

final String packageName = 'com.feedmart.seller';

final String iosPackage = 'com.feedmart.seller';
...
final String baseUrl = 'https://developmentalphawizz.com/feedmart/seller/app/v1/api/';
