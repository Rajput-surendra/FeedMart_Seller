...
const Color primary =Color(0xff09366F);
const Color secondary = Color(0xffF9960F);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xff09366F);
const Color grad2Color = Color(0xff09366F);
